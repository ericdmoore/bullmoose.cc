                  ...
                  >
                    ...
                    <div class="divide-y divide-gray-200 dark:divide-white/10">
                      <div class="pb-6">
                        ...
                        >
                          <div>
                            <div class="-m-1 flex">
                              <div
                                class="inline-flex overflow-hidden rounded-lg border-4 border-white dark:border-gray-800"
                              >
                                <img
                                  class="size-24 shrink-0 bg-gray-100 outline -outline-offset-1 outline-black/5 sm:size-40 lg:size-48 dark:bg-gray-800 dark:outline-white/10"
                          ...
                          <div class="mt-6 sm:ml-6 sm:flex-1">
                            ...
                            <div class="mt-5 flex flex-wrap space-y-3 sm:space-y-0 sm:space-x-3">
                              ...
                              <button
                                type="button"
                                class="inline-flex w-full flex-1 items-center justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-xs inset-ring inset-ring-gray-300 hover:bg-gray-50 dark:bg-white/10 dark:text-gray-100 dark:shadow-none dark:inset-ring-white/5 dark:hover:bg-white/20"
                              >
                                Call
                              </button>
                              <div class="ml-3 inline-flex sm:ml-0">
                                <Menu as="div" class="relative inline-block text-left">
                                  <MenuButton
                                    class="relative inline-flex items-center rounded-md bg-white p-2 text-gray-400 shadow-xs inset-ring inset-ring-gray-300 hover:bg-gray-50 dark:bg-white/10 dark:text-gray-100 dark:shadow-none dark:inset-ring-white/5 dark:hover:bg-white/20"
                                  >
                                  ...
                                  >
                                    <MenuItems
                                      class="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white shadow-lg outline-1 outline-black/5 dark:bg-gray-800 dark:-outline-offset-1 dark:outline-white/10"
                                    >
                                      <div class="py-1">
                      ...
                      <div class="px-4 py-5 sm:px-0 sm:py-0">
                        <dl
                          class="space-y-8 sm:space-y-0 sm:divide-y sm:divide-gray-200 dark:sm:divide-white/10"
                        >
                          <div class="sm:flex sm:px-6 sm:py-5">
                            <dt
                              class="text-sm font-medium text-gray-500 sm:w-40 sm:shrink-0 lg:w-48 dark:text-gray-400"
                            >
                              Bio
                            </dt>
                            <dd
                              class="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0 sm:ml-6 dark:text-white"
                            >
                              <p>
