                      ...
                      <li v-for="person in team" :key="person.handle">
                        <div class="group relative flex items-center px-5 py-6">
                          <a :href="person.href" class="-m-1 block flex-1 p-1">
                            <div
                              class="absolute inset-0 group-hover:bg-gray-50 dark:group-hover:bg-white/2.5"
                              aria-hidden="true"
                            ></div>
                          ...
                          <Menu as="div" class="relative ml-2 inline-block shrink-0 text-left">
                            <MenuButton
                              class="group relative inline-flex size-8 items-center justify-center rounded-full bg-white focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 dark:bg-gray-800 dark:focus-visible:outline-indigo-500"
                            >
                              <span class="absolute -inset-1.5"></span>
                              <span class="sr-only">Open options menu</span>
                              <span class="flex size-full items-center justify-center rounded-full">
                                <EllipsisVerticalIcon
                                  class="size-5 text-gray-400 group-hover:text-gray-500 dark:group-hover:text-gray-300"
                                  aria-hidden="true"
                                />
                              </span>
                            </MenuButton>
                            ...
                            >
                              <MenuItems
                                class="absolute top-0 right-full z-10 mr-1 w-48 origin-top-right rounded-md bg-white shadow-lg outline-1 outline-black/5 dark:bg-gray-800 dark:-outline-offset-1 dark:outline-white/10"
                              >
                                <div class="py-1">
