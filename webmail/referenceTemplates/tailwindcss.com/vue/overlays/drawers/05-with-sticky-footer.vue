                ...
                <DialogPanel class="pointer-events-auto w-screen max-w-md">
                  ...
                  >
                    ...
                    <div class="flex shrink-0 justify-end px-4 py-4">
                      <button
                        type="button"
                        class="rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-xs inset-ring inset-ring-gray-300 hover:inset-ring-gray-400 dark:bg-white/10 dark:text-white dark:shadow-none dark:inset-ring-white/5 dark:hover:bg-white/20 dark:hover:inset-ring-white/5"
                        @click="open = false"
                      >
                        Cancel
                      </button>
