<template>
  <Menu as="div" class="relative inline-block">
    ...
    >
      <MenuItems
        class="absolute right-0 z-10 mt-2 w-56 origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg outline-1 outline-black/5 dark:divide-white/10 dark:bg-gray-800 dark:shadow-none dark:-outline-offset-1 dark:outline-white/10"
      >
        <div class="px-4 py-3">
          <p class="text-sm text-gray-700 dark:text-gray-400">Signed in as</p>
          <p class="truncate text-sm font-medium text-gray-900 dark:text-white">tom@example.com</p>
        </div>
        <div class="py-1">
