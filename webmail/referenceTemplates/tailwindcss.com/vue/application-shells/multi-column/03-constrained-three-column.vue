<template>
  ...
  <div class="flex min-h-full flex-col">
    <header
      class="relative shrink-0 bg-gray-900 dark:before:pointer-events-none dark:before:absolute dark:before:inset-0 dark:before:border-b dark:before:border-white/10 dark:before:bg-black/10"
    >
      <div
