<template>
  ...
  <div>
            ...
            <DialogPanel class="relative mr-16 flex w-full max-w-xs flex-1">
              ...
              >
                <div class="relative flex h-16 shrink-0 items-center">
                  ...
                  />
                  <img
                    class="relative h-8 w-auto not-dark:hidden"
                    ...
                    <li>
                      ...
                      <ul role="list" class="-mx-2 mt-2 space-y-1">
                        <li v-for="team in teams" :key="team.name">
                          ...
                          >
                            <span
                              class="flex size-6 shrink-0 items-center justify-center rounded-lg border border-white/10 bg-gray-800 text-[0.625rem] font-medium text-gray-400 group-hover:border-white/20 group-hover:text-white"
                              >{{ team.initial }}</span
                            >
    ...
    <div class="hidden bg-gray-900 lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
      <!-- Sidebar component, swap this element with another sidebar if you like -->
      <div
        class="flex grow flex-col gap-y-5 overflow-y-auto border-r border-gray-200 px-6 dark:border-white/10 dark:bg-black/10"
      >
    ...
    <div
      class="sticky top-0 z-40 flex items-center gap-x-6 bg-gray-900 px-4 py-4 shadow-sm sm:px-6 lg:hidden dark:shadow-none dark:after:pointer-events-none dark:after:absolute dark:after:inset-0 dark:after:border-b dark:after:border-white/10 dark:after:bg-black/10"
    >
      <button
        type="button"
