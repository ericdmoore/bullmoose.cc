            ...
            <div class="hidden lg:ml-4 lg:block">
              <div class="flex items-center">
                ...
                <Menu as="div" class="relative ml-3 shrink-0">
                  ...
                  >
                    <MenuItems
                      class="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg outline-1 outline-black/5 dark:bg-gray-800 dark:-outline-offset-1 dark:outline-white/10"
                    >
