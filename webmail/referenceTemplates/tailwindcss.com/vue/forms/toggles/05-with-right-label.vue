<template>
  <div class="flex items-center justify-between gap-3">
    ...
    <div class="text-sm">
      <label id="annual-billing-label" class="font-medium text-gray-900 dark:text-white"
        >Annual billing</label
      >
      {{ " " }}
      <span id="annual-billing-description" class="text-gray-500 dark:text-gray-400"
        >(Save 10%)</span
      >
    </div>
  </div>
