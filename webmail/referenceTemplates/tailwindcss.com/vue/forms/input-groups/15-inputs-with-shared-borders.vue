<template>
  <div>
    <fieldset>
      <legend class="block text-sm/6 font-medium text-gray-900 dark:text-white">
        Card details
      </legend>
      <div class="mt-2 grid grid-cols-2">
        ...
        <div class="-mt-px -mr-px">
          <input
            ...
            class="block w-full rounded-bl-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:relative focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6 dark:bg-white/5 dark:text-white dark:outline-gray-700 dark:placeholder:text-gray-500 dark:focus:outline-indigo-500"
            placeholder="MM / YY"
          />
        </div>
        <div class="-mt-px">
          <input
            ...
            name="card-cvc"
            aria-label="CVC"
            class="block w-full rounded-br-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:relative focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6 dark:bg-white/5 dark:text-white dark:outline-gray-700 dark:placeholder:text-gray-500 dark:focus:outline-indigo-500"
            placeholder="CVC"
          />
        </div>
      </div>
      ...
      <div class="mt-2">
        <div class="grid grid-cols-1 focus-within:relative">
          <select
            ...
            aria-label="Country"
            class="col-start-1 row-start-1 w-full appearance-none rounded-t-md bg-white py-1.5 pr-8 pl-3 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6 dark:bg-white/5 dark:text-white dark:outline-gray-700 dark:*:bg-gray-800 dark:placeholder:text-gray-500 dark:focus:outline-indigo-500"
          >
