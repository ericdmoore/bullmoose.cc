<template>
  <div>
    <label for="company-website" class="block text-sm/6 font-medium text-gray-900 dark:text-white"
    ...
    <div class="mt-2">
      ...
      >
        ...
        <input
          ...
          id="company-website"
          class="block min-w-0 grow py-1.5 pr-3 pl-1 text-base text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm/6 dark:text-white dark:placeholder:text-gray-500"
