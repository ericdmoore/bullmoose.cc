  ...
  <form>
    <div class="space-y-12 sm:space-y-16">
        ...
        >
          <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
            ...
            <div class="mt-2 sm:col-span-2 sm:mt-0">
              <div
                class="flex items-center rounded-md bg-white pl-3 outline-1 -outline-offset-1 outline-gray-300 focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-indigo-600 sm:max-w-md dark:bg-white/5 dark:outline-white/10 dark:focus-within:outline-indigo-500"
              >
                <div
          ...
          <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
            ...
            <div class="mt-2 sm:col-span-2 sm:mt-0">
              <div
                class="flex max-w-2xl justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10 dark:border-white/25"
              >
      ...
      <div>
        ...
        <div
          class="mt-10 space-y-10 border-b border-gray-900/10 pb-12 sm:space-y-0 sm:divide-y sm:divide-gray-900/10 sm:border-t sm:border-t-gray-900/10 sm:pb-0 dark:border-white/10 dark:sm:divide-white/10 dark:sm:border-t-white/10"
        >
          <fieldset>
            <legend class="sr-only">By email</legend>
            <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:py-6">
              <div class="text-sm/6 font-semibold text-gray-900 dark:text-white" aria-hidden="true">
                By email
              </div>
