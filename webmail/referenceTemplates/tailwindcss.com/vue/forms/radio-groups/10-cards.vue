    ...
    <div class="mt-6 grid grid-cols-1 gap-y-6 sm:grid-cols-3 sm:gap-x-4">
      ...
      >
        ...
        <div class="flex-1">
          ...
          <span class="mt-6 block text-sm font-medium text-gray-900 dark:text-white">{{
            mailingList.users
          }}</span>
        </div>
        <CheckCircleIcon
          class="invisible size-5 text-indigo-600 group-has-checked:visible dark:text-indigo-500"
          aria-hidden="true"
        />
      </label>
    </div>
