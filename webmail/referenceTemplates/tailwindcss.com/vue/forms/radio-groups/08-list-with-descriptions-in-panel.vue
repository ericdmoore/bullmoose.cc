<template>
  <fieldset
    ...
    class="-space-y-px rounded-md bg-white dark:bg-gray-800/50"
  >
    <label
    ...
    >
      ...
      <span class="ml-3 flex flex-col">
        <span
          class="block text-sm font-medium text-gray-900 group-has-checked:text-indigo-900 dark:text-white dark:group-has-checked:text-indigo-300"
          >{{ setting.name }}</span
        >
        <span
          class="block text-sm text-gray-500 group-has-checked:text-indigo-700 dark:text-gray-400 dark:group-has-checked:text-indigo-300/75"
