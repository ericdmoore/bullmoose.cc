    ...
    <div class="space-y-5">
      <div class="flex gap-3">
        ...
        <div class="text-sm/6">
          ...
          >
          {{ " " }}
          <span id="comments-description" class="text-gray-500 dark:text-gray-400"
      ...
      <div class="flex gap-3">
        ...
        <div class="text-sm/6">
          ...
          >
          {{ " " }}
          <span id="candidates-description" class="text-gray-500 dark:text-gray-400"
            ><span class="sr-only">New candidates </span>who apply for any open postings.</span
          >
        </div>
      </div>
      <div class="flex gap-3">
        ...
        <div class="text-sm/6">
          ...
          {{ " " }}
          <span id="offers-description" class="text-gray-500 dark:text-gray-400"
            ><span class="sr-only">Offers </span>when they are accepted or rejected by
            candidates.</span
          >
        </div>
      </div>
