<template>
  <Listbox as="div" v-model="selected">
    ...
    <div class="relative mt-2">
      ...
      >
        <span class="col-start-1 row-start-1 flex items-center gap-3 pr-6">
          <img
            :src="selected.avatar"
            alt=""
            class="size-5 shrink-0 rounded-full bg-gray-100 dark:bg-gray-700 dark:outline dark:-outline-offset-1 dark:outline-white/10"
          />
      ...
      >
        <ListboxOptions
          class="absolute z-10 mt-1 max-h-56 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg outline-1 outline-black/5 sm:text-sm dark:bg-gray-800 dark:shadow-none dark:-outline-offset-1 dark:outline-white/10"
        >
          <ListboxOption
            as="template"
            ...
            >
              <div class="flex items-center">
                <img
                  :src="person.avatar"
                  alt=""
                  class="size-5 shrink-0 rounded-full dark:outline dark:-outline-offset-1 dark:outline-white/10"
                />
                <span
