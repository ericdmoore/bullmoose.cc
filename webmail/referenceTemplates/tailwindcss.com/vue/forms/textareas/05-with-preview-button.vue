      ...
      <div class="group flex items-center">
        <TabList class="flex gap-2">
          <Tab as="template" v-slot="{ selected }">
            <button
              :class="[
                selected
                  ? 'bg-gray-100 text-gray-900 hover:bg-gray-200 dark:bg-white/10 dark:text-white dark:hover:bg-white/10'
                  : 'bg-white text-gray-500 hover:bg-gray-100 hover:text-gray-900 dark:bg-gray-900 dark:text-gray-400 dark:hover:bg-white/10 dark:hover:text-white',
        ...
        >
          <div class="flex items-center">
            <button
              type="button"
              class="-m-2.5 inline-flex size-10 items-center justify-center rounded-full text-gray-400 hover:text-gray-500 dark:text-gray-500 dark:hover:text-white"
            >
      ...
      <TabPanels class="mt-2">
        ...
        <TabPanel class="-m-0.5 rounded-lg p-0.5">
          <div class="border-b border-gray-200 dark:border-white/10">
            <div class="mx-px mt-px px-3 pt-2 pb-12 text-sm text-gray-800 dark:text-gray-300">
