<template>
  <div class="flex">
    <div class="mr-4 shrink-0">
      <svg
        class="size-16 border border-gray-300 bg-white text-gray-300 dark:border-white/15 dark:bg-gray-900 dark:text-white/15"
    ...
    <div>
      ...
      <div class="mt-6 flex">
        <div class="mr-4 shrink-0">
          <svg
            class="size-12 border border-gray-300 bg-white text-gray-300 dark:border-white/15 dark:bg-gray-900 dark:text-white/15"
            preserveAspectRatio="none"
            stroke="currentColor"
            fill="none"
            viewBox="0 0 200 200"
