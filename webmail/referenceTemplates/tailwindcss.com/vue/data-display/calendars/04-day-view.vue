<template>
  <div class="flex h-full flex-col">
    ...
    >
      ...
      <div class="flex items-center">
        ...
        <div class="ml-6 md:hidden">
          <Menu as="div" class="relative">
            <MenuButton
              class="relative flex items-center rounded-full text-gray-400 outline-offset-8 hover:text-gray-500 dark:text-gray-500 dark:hover:text-white"
            >
    ...
    <div class="isolate flex flex-auto overflow-hidden bg-white dark:bg-gray-900">
      <div class="flex flex-auto flex-col overflow-auto">
        ...
        >
          <button type="button" class="flex flex-col items-center pt-3 pb-1.5">
            ...
            <span
              class="mt-3 flex size-8 items-center justify-center rounded-full text-base font-semibold text-gray-900 dark:text-white"
              >19</span
            >
          </button>
          <button type="button" class="flex flex-col items-center pt-3 pb-1.5">
            <span>T</span>
            <span
              class="mt-3 flex size-8 items-center justify-center rounded-full text-base font-semibold text-indigo-600 dark:text-indigo-400"
              >20</span
            >
          </button>
          <button type="button" class="flex flex-col items-center pt-3 pb-1.5">
          ...
          <button type="button" class="flex flex-col items-center pt-3 pb-1.5">
            <span>S</span>
            <span
              class="mt-3 flex size-8 items-center justify-center rounded-full bg-gray-900 text-base font-semibold text-white dark:bg-white dark:text-gray-900"
              >22</span
            >
          </button>
          <button type="button" class="flex flex-col items-center pt-3 pb-1.5">
          ...
          <div class="grid flex-auto grid-cols-1 grid-rows-1">
            ...
            >
              ...
              >
                ...
                >
                  <p class="order-1 font-semibold text-indigo-700 dark:text-indigo-300">
                    Sightseeing
                  </p>
                  <p
      ...
      <div
        class="hidden w-1/2 max-w-md flex-none border-l border-gray-100 px-8 py-10 md:block dark:border-white/10"
      >
