<template>
  <div>
    <header
      class="flex items-center justify-between border-b border-gray-200 px-6 py-4 dark:border-white/10 dark:bg-gray-800/50"
    >
      ...
      <div class="flex items-center">
        ...
        <div class="hidden md:ml-4 md:flex md:items-center">
          <Menu as="div" class="relative">
            ...
            >
              <MenuItems
                class="absolute right-0 z-10 mt-3 w-36 origin-top-right overflow-hidden rounded-md bg-white shadow-lg outline-1 outline-black/5 dark:bg-gray-800 dark:shadow-none dark:-outline-offset-1 dark:outline-white/5"
              >
                <div class="py-1">
        ...
        <div class="ml-6 md:hidden">
          <Menu as="div" class="relative">
            ...
            >
              <MenuItems
                class="absolute right-0 z-10 mt-3 w-36 origin-top-right divide-y divide-gray-100 overflow-hidden rounded-md bg-white shadow-lg outline-1 outline-black/5 dark:divide-white/10 dark:bg-gray-800 dark:-outline-offset-1 dark:outline-white/5"
              >
                <div class="py-1">
                  <MenuItem v-slot="{ active }">
                    <a
