  ...
  <div>
    ...
    <div class="mt-2 grid grid-cols-7 text-sm">
      <div
        ...
        class="py-2 not-data-first-line:border-t not-data-first-line:border-gray-200 dark:not-data-first-line:border-white/10"
      >
        <button
          type="button"
    ...
    <section class="mt-12">
      ...
      <ol class="mt-4 flex flex-col gap-y-1 text-sm/6 text-gray-500 dark:text-gray-400">
        <li
          ...
          :key="meeting.id"
          class="group flex items-center gap-x-4 rounded-xl px-4 py-2 focus-within:bg-gray-100 hover:bg-gray-100 dark:focus-within:bg-white/5 dark:hover:bg-white/5"
        >
          ...
          >
            <MenuButton
              class="relative flex items-center rounded-full text-gray-500 outline-offset-6 hover:text-gray-600 dark:text-gray-400 dark:hover:text-white"
            >
