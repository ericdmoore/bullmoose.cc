<template>
  ...
  <div>
        ...
        <div class="fixed inset-0 flex">
          ...
          >
            <DialogPanel class="relative mr-16 flex w-full max-w-xs flex-1">
              ...
              <div
                class="relative flex grow flex-col gap-y-5 overflow-y-auto bg-gray-50 px-6 dark:bg-gray-900 dark:ring dark:ring-white/10 dark:before:pointer-events-none dark:before:absolute dark:before:inset-0 dark:before:bg-black/10"
              >
    ...
    <div class="xl:pl-72">
      ...
      <div
        class="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-6 border-b border-gray-200 bg-white px-4 shadow-xs sm:px-6 lg:px-8 dark:border-white/5 dark:bg-gray-900 dark:shadow-none"
      >
        <button
          type="button"
      ...
      <main>
        <header>
          ...
          <!-- Heading -->
          <div
            class="flex flex-col items-start justify-between gap-x-8 gap-y-4 bg-gray-50 px-4 py-4 sm:flex-row sm:items-center sm:px-6 lg:px-8 dark:bg-gray-700/10"
          >
            <div>
              <div class="flex items-center gap-x-3">
                <div
                  class="flex-none rounded-full bg-green-500/10 p-1 text-green-500 dark:bg-green-400/10 dark:text-green-400"
                >
            ...
            <div
              class="order-first flex-none rounded-full bg-indigo-50 px-2 py-1 text-xs font-medium text-indigo-500 ring-1 ring-indigo-200 ring-inset sm:order-0 dark:bg-indigo-400/10 dark:text-indigo-400 dark:ring-indigo-400/30"
            >
              Production
            </div>
          </div>
          ...
          <!-- Stats -->
          <div
            class="grid grid-cols-1 bg-gray-50 sm:grid-cols-2 lg:grid-cols-4 dark:bg-gray-700/10"
          >
            <div
        ...
        <div class="border-t border-gray-200 pt-11 dark:border-white/10">
          ...
          <table class="mt-6 w-full text-left whitespace-nowrap">
            ...
            <thead
              class="border-b border-gray-200 text-sm/6 text-gray-900 dark:border-white/10 dark:text-white"
            >
              <tr>
              ...
              <tr v-for="item in activityItems" :key="item.commit">
                ...
                <td class="hidden py-4 pr-4 pl-0 sm:table-cell sm:pr-8">
                  <div class="flex gap-x-3">
                    ...
                    <span
                      class="inline-flex items-center rounded-md bg-gray-50 px-2 py-1 text-xs font-medium text-gray-600 ring-1 ring-gray-300 ring-inset dark:bg-gray-400/10 dark:text-gray-400 dark:ring-gray-400/20"
                      >{{ item.branch }}</span
                    >
                  </div>
                </td>
                ...
                <td
                  class="hidden py-4 pr-8 pl-0 text-sm/6 text-gray-500 md:table-cell lg:pr-20 dark:text-gray-400"
                >
                  {{ item.duration }}
                </td>
                <td
                  class="hidden py-4 pr-4 pl-0 text-right text-sm/6 text-gray-500 sm:table-cell sm:pr-6 lg:pr-8 dark:text-gray-400"
                >
