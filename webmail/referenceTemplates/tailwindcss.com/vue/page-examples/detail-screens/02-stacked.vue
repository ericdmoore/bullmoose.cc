<template>
  <header
    class="absolute inset-x-0 top-0 z-50 flex h-16 border-b border-gray-900/10 dark:border-white/10"
  >
    <div class="mx-auto flex w-full max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
      ...
      <nav
        class="hidden md:flex md:gap-x-11 md:text-sm/6 md:font-semibold md:text-gray-700 dark:md:text-gray-300"
      >
    ...
    <Dialog class="lg:hidden" @close="mobileMenuOpen = false" :open="mobileMenuOpen">
      ...
      <DialogPanel
        class="fixed inset-y-0 left-0 z-50 w-full overflow-y-auto bg-white px-4 pb-6 sm:max-w-sm sm:px-6 sm:ring-1 sm:ring-gray-900/10 dark:bg-gray-900 dark:sm:ring-white/10"
      >
  ...
  <main>
    <header class="relative isolate pt-16">
      <div class="absolute inset-0 -z-10 overflow-hidden" aria-hidden="true">
        <div
          class="absolute top-full left-16 -mt-16 transform-gpu opacity-50 blur-3xl xl:left-1/2 xl:-ml-80 dark:opacity-30"
        >
          <div
    ...
    <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      >
          ...
          >
            <dl class="flex flex-wrap">
              ...
              <div class="flex-none self-end px-6 pt-4">
                ...
                <dd
                  class="rounded-md bg-green-50 px-2 py-1 text-xs font-medium text-green-600 ring-1 ring-green-600/20 ring-inset dark:bg-green-500/10 dark:text-green-500 dark:ring-green-500/30"
                >
                  Paid
                </dd>
              </div>
              <div
                class="mt-6 flex w-full flex-none gap-x-4 border-t border-gray-900/5 px-6 pt-6 dark:border-white/10"
              >
                <dt class="flex-none">
                  <span class="sr-only">Client</span>
                  <UserCircleIcon
                    class="h-6 w-5 text-gray-400 dark:text-gray-500"
                    aria-hidden="true"
                  />
                </dt>
        ...
        <!-- Invoice -->
        <div
          class="-mx-4 px-4 py-8 shadow-xs ring-1 ring-gray-900/5 sm:mx-0 sm:rounded-lg sm:px-8 sm:pb-14 lg:col-span-2 lg:row-span-2 lg:row-end-2 xl:px-16 xl:pt-16 xl:pb-20 dark:shadow-none dark:ring-white/10"
        >
          ...
          <dl class="mt-6 grid grid-cols-1 text-sm/6 sm:grid-cols-2">
            ...
            <div class="mt-6 border-t border-gray-900/5 pt-6 sm:pr-4 dark:border-white/10">
              ...
              <dd class="mt-2 text-gray-500 dark:text-gray-400">
                <span class="font-medium text-gray-900 dark:text-white">Acme, Inc.</span><br />7363
                Cynthia Pass<br />Toronto, ON N3Y 4H8
              </dd>
            </div>
            <div
              class="mt-8 sm:mt-6 sm:border-t sm:border-gray-900/5 sm:pt-6 sm:pl-4 dark:sm:border-white/10"
            >
              <dt class="font-semibold text-gray-900 dark:text-white">To</dt>
              <dd class="mt-2 text-gray-500 dark:text-gray-400">
                <span class="font-medium text-gray-900 dark:text-white">Tuple, Inc</span><br />886
          ...
          <table class="mt-16 w-full text-left text-sm/6 whitespace-nowrap">
            ...
            <thead
              class="border-b border-gray-200 text-gray-900 dark:border-white/15 dark:text-white"
            >
              <tr>
            ...
            <tbody>
              ...
              >
                ...
                <td
                  class="hidden py-5 pr-0 pl-8 text-right align-top text-gray-700 tabular-nums sm:table-cell dark:text-gray-300"
                >
                  {{ item.hours }}
                </td>
                <td
                ...
                <td
                  class="py-5 pr-0 pl-8 text-right align-top text-gray-700 tabular-nums dark:text-gray-300"
                >
                  {{ item.price }}
                </td>
              </tr>
            ...
            <tfoot>
              <tr>
                ...
                <td
                  class="pt-6 pr-0 pb-0 pl-8 text-right text-gray-900 tabular-nums dark:text-white"
                >
                  {{ invoice.subTotal }}
                </td>
              </tr>
              <tr>
                <th scope="row" class="pt-4 font-normal text-gray-700 sm:hidden dark:text-gray-300">
                  Tax
                </th>
                <th
                  scope="row"
                ...
                <td
                  class="pt-4 pr-0 pb-0 pl-8 text-right text-gray-900 tabular-nums dark:text-white"
                >
                  {{ invoice.tax }}
                </td>
              </tr>
              <tr>
                <th scope="row" class="pt-4 font-semibold text-gray-900 sm:hidden dark:text-white">
                  Total
                </th>
                <th
                  scope="row"
                ...
                <td
                  class="pt-4 pr-0 pb-0 pl-8 text-right font-semibold text-gray-900 tabular-nums dark:text-white"
                >
                  {{ invoice.total }}
                </td>
              </tr>
        ...
        <div class="lg:col-start-3">
          ...
          <ul role="list" class="mt-6 space-y-6">
            ...
            >
              ...
              <template v-if="activityItem.type === 'commented'">
                ...
                />
                <div
                  class="flex-auto rounded-md p-3 ring-1 ring-gray-200 ring-inset dark:ring-white/10"
                >
              ...
              <template v-else>
                ...
                >
                  ...
                  <div
                    v-else
                    class="size-1.5 rounded-full bg-gray-100 ring-1 ring-gray-300 dark:bg-white/10 dark:ring-white/20"
                  ></div>
                </div>
          ...
          <div class="mt-6 flex gap-x-3">
            ...
            <form action="#" class="relative flex-auto">
              <div
                class="overflow-hidden rounded-lg pb-12 outline-1 -outline-offset-1 outline-gray-300 focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-indigo-600 dark:bg-white/5 dark:outline-white/10 dark:focus-within:outline-indigo-500"
              >
                ...
                <div class="flex items-center space-x-5">
                  ...
                  <div class="flex items-center">
                    <Listbox as="div" v-model="selected">
                      ...
                      <div class="relative">
                        <ListboxButton
                          class="relative -m-2.5 flex size-10 items-center justify-center rounded-full text-gray-400 hover:text-gray-500 dark:text-gray-500 dark:hover:text-white"
                        >
                        ...
                        >
                          <ListboxOptions
                            class="absolute bottom-10 z-10 -ml-6 w-60 rounded-lg bg-white py-3 text-base shadow-sm outline-1 outline-black/5 sm:ml-auto sm:w-64 sm:text-sm dark:bg-gray-800 dark:shadow-none dark:-outline-offset-1 dark:outline-white/10"
                          >
                            <ListboxOption
                              as="template"
                              v-for="mood in moods"
                            ...
                            >
                              <li
                                :class="[
                                  ...
                                  'relative cursor-default px-3 py-2 text-gray-900 select-none dark:text-white',
                                ]"
                              >
                                <div class="flex items-center">
                                  <div
