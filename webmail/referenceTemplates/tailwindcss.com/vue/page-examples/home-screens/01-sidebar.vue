<template>
  ...
  <div>
    ...
    <div class="xl:pl-72">
      ...
      <main class="lg:pr-96">
        <header
          class="flex items-center justify-between border-b border-gray-200 px-4 py-4 sm:px-6 sm:py-6 lg:px-8 dark:border-white/5"
        >
          ...
          <Menu as="div" class="relative">
            <MenuButton
              class="flex items-center gap-x-1 text-sm/6 font-medium text-gray-900 dark:text-white"
            >
              Sort by
      ...
      <!-- Activity feed -->
      <aside
        class="bg-gray-50 lg:fixed lg:top-16 lg:right-0 lg:bottom-0 lg:w-96 lg:overflow-y-auto lg:border-l lg:border-gray-200 dark:bg-black/10 dark:lg:border-white/5"
      >
        <header
          class="flex items-center justify-between border-b border-gray-200 px-4 py-4 sm:px-6 sm:py-6 lg:px-8 dark:border-white/5"
        >
        ...
        <ul role="list" class="divide-y divide-gray-100 dark:divide-white/5">
          <li v-for="item in activityItems" :key="item.commit" class="px-4 py-4 sm:px-6 lg:px-8">
            ...
            <p class="mt-3 truncate text-sm text-gray-500">
              Pushed to
              <span class="text-gray-700 dark:text-gray-400">{{ item.projectName }}</span> (<span
                class="font-mono text-gray-700 dark:text-gray-400"
                >{{ item.commit }}</span
              >
              on <span class="text-gray-700 dark:text-gray-400">{{ item.branch }}</span
              >)
            </p>
          </li>
        </ul>
