<template>
    ...
    >
      ...
      <template v-if="activityItem.type === 'commented'">
        <img
          ...
          alt=""
          class="relative mt-3 size-6 flex-none rounded-full bg-gray-50 outline -outline-offset-1 outline-black/5 dark:bg-gray-800 dark:outline-white/10"
        />
  ...
  <div class="mt-6 flex gap-x-3">
    <img
      ...
      alt=""
      class="size-6 flex-none rounded-full bg-gray-50 outline -outline-offset-1 outline-black/5 dark:bg-gray-800 dark:outline-white/10"
    />
