      ...
      <dl class="-my-3 divide-y divide-gray-100 px-6 py-4 text-sm/6 dark:divide-white/10">
        ...
        <div class="flex justify-between gap-x-4 py-3">
          ...
          <dd class="flex items-start gap-x-2">
            ...
            <div
              v-if="client.lastInvoice.status == 'Paid'"
            ...
            <div
              v-if="client.lastInvoice.status == 'Withdraw'"
              class="rounded-md bg-gray-50 px-2 py-1 text-xs font-medium text-gray-600 ring-1 ring-gray-500/10 ring-inset dark:bg-white/5 dark:text-gray-400 dark:ring-white/10"
            >
              {{ client.lastInvoice.status }}
            </div>
            <div
              v-if="client.lastInvoice.status == 'Overdue'"
