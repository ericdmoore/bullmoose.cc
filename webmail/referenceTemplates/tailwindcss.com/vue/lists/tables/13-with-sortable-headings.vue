              ...
              <tr>
                ...
                >
                  <a href="#" class="group inline-flex">
                    Name
                    <span
                      class="invisible ml-2 flex-none rounded-sm text-gray-400 group-hover:visible group-focus:visible dark:text-gray-500"
                    >
                ...
                >
                  <a href="#" class="group inline-flex">
                    Title
                    <span
                      class="ml-2 flex-none rounded-sm bg-gray-100 text-gray-900 group-hover:bg-gray-200 dark:bg-gray-800 dark:text-white dark:group-hover:bg-gray-700"
                    >
                      <ChevronDownIcon class="size-5" aria-hidden="true" />
                    </span>
                  </a>
                ...
                >
                  <a href="#" class="group inline-flex">
                    ...
                    >
                      <ChevronDownIcon
                        class="invisible ml-2 size-5 flex-none rounded-sm text-gray-400 group-hover:visible group-focus:visible dark:text-gray-500"
                        aria-hidden="true"
                      />
                    </span>
                  </a>
