    ...
    <div class="sm:flex sm:items-center">
      <div class="sm:flex-auto">
        ...
        <p class="mt-2 text-sm text-gray-700 dark:text-gray-300">
          Your team is on the
          <strong class="font-semibold text-gray-900 dark:text-white">Startup</strong> plan. The
          next payment of $80 will be due on August 4, 2022.
        </p>
      </div>
      ...
      <table class="relative min-w-full divide-y divide-gray-300 dark:divide-white/15">
        <thead>
          <tr>
            <th
              scope="col"
              class="py-3.5 pr-3 pl-4 text-left text-sm font-semibold text-gray-900 sm:pl-6 dark:text-white"
            >
              Plan
            </th>
            <th
          ...
          <tr v-for="(plan, planIdx) in plans" :key="plan.id">
            ...
            >
              <div class="font-medium text-gray-900 dark:text-white">
                {{ plan.name }}
                <span v-if="plan.isCurrent" class="ml-1 text-indigo-600 dark:text-indigo-400"
                  >(Current Plan)</span
                >
              </div>
              ...
              <div
                v-if="planIdx !== 0"
                class="absolute -top-px right-0 left-6 h-px bg-gray-200 dark:bg-white/10"
              ></div>
            </td>
            <td
              :class="[
            ...
            >
              ...
              <div
                v-if="planIdx !== 0"
                class="absolute -top-px right-6 left-0 h-px bg-gray-200 dark:bg-white/10"
              ></div>
            </td>
          </tr>
        </tbody>
