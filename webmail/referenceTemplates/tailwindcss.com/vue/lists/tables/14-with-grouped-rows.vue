              ...
              <template v-for="location in locations" :key="location.name">
                <tr class="border-t border-gray-200 dark:border-white/10">
                  <th
                    colspan="5"
                    scope="colgroup"
                    class="bg-gray-50 py-2 pr-3 pl-4 text-left text-sm font-semibold text-gray-900 sm:pl-3 dark:bg-gray-800/50 dark:text-white"
                  >
                    {{ location.name }}
                  </th>
                </tr>
                ...
                >
                  <td
                    class="py-4 pr-3 pl-4 text-sm font-medium whitespace-nowrap text-gray-900 sm:pl-3 dark:text-white"
                  >
                    {{ person.name }}
                  </td>
