    ...
    <div class="mx-auto flex items-center justify-between gap-x-8 lg:mx-0">
      <div class="flex items-center gap-x-6">
        <img
          ...
          alt=""
          class="size-16 flex-none rounded-full outline outline-gray-900/10 dark:outline-white/10"
        />
        <h1>
      ...
      <div class="flex items-center gap-x-4 sm:gap-x-6">
        ...
        <a href="#" class="hidden text-sm/6 font-semibold text-gray-900 sm:block dark:text-white"
          >Edit</a
        >
        <a
          href="#"
