<template>
  <div class="lg:flex lg:items-center lg:justify-between">
    <div class="min-w-0 flex-1">
      ...
      <h2
        class="mt-2 text-2xl/7 font-bold text-gray-900 sm:truncate sm:text-3xl sm:tracking-tight dark:text-white"
      >
        Back End Developer
      </h2>
    ...
    <div class="mt-5 flex lg:mt-0 lg:ml-4">
      <span class="hidden sm:block">
        ...
        >
          <PencilIcon
            class="mr-1.5 -ml-0.5 size-5 text-gray-400 dark:text-white"
            aria-hidden="true"
          />
          Edit
        </button>
      ...
      <Menu as="div" class="relative ml-3 sm:hidden">
        ...
        >
          <MenuItems
            class="absolute left-0 z-10 mt-2 -mr-1 w-24 origin-top-right rounded-md bg-white py-1 shadow-lg outline-1 outline-black/5 dark:bg-gray-800 dark:shadow-none dark:-outline-offset-1 dark:outline-white/10"
          >
