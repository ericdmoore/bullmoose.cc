<template>
  <div class="lg:border-t lg:border-b lg:border-gray-200 dark:lg:border-white/15">
    <nav class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8" aria-label="Progress">
      <ol
        role="list"
        class="overflow-hidden rounded-md lg:flex lg:rounded-none lg:border-r lg:border-l lg:border-gray-200 dark:lg:border-white/15"
      >
        <li
          ...
          >
            <a v-if="step.status === 'complete'" :href="step.href" class="group">
              ...
              >
                <span class="shrink-0">
                  <span
                    class="flex size-10 items-center justify-center rounded-full bg-indigo-600 dark:bg-indigo-500"
                  >
            ...
            <a v-else-if="step.status === 'current'" :href="step.href" aria-current="step">
              <span
                class="absolute top-0 left-0 h-full w-1 bg-indigo-600 lg:top-auto lg:bottom-0 lg:h-1 lg:w-full dark:bg-indigo-500"
                aria-hidden="true"
              ></span>
              <span
                :class="[
              ...
              >
                <span class="shrink-0">
                  <span
                    class="flex size-10 items-center justify-center rounded-full border-2 border-indigo-600 dark:border-indigo-500"
                  >
