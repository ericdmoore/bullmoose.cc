    ...
    <div class="mx-auto max-w-7xl px-2 sm:px-4 lg:divide-y lg:divide-white/10 lg:px-8">
      <div class="relative flex h-16 justify-between">
        ...
        >
          <div class="grid w-full grid-cols-1 sm:max-w-xs">
            <input
              name="search"
              aria-label="Search"
              class="col-start-1 row-start-1 block w-full rounded-md border-0 bg-white/5 py-1.5 pr-3 pl-10 text-white outline -outline-offset-1 outline-white/10 placeholder:text-gray-500 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500 sm:text-sm/6"
              placeholder="Search"
            />
            <MagnifyingGlassIcon
        ...
        <div class="relative z-10 flex items-center lg:hidden">
          <!-- Mobile menu button -->
          <DisclosureButton
            class="relative inline-flex items-center justify-center rounded-md p-2 text-gray-400 hover:bg-white/5 hover:text-gray-300 focus:outline-2 focus:-outline-offset-1 focus:outline-indigo-500"
          >
        ...
        <div class="hidden lg:relative lg:z-10 lg:ml-4 lg:flex lg:items-center">
          ...
          <Menu as="div" class="relative ml-4 shrink-0">
            <MenuButton
              class="relative flex rounded-full focus-visible:ring-offset-2 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500"
            >
              <span class="absolute -inset-1.5"></span>
