  ...
  <TransitionRoot :show="open" as="template" @after-leave="query = ''" appear>
    <Dialog class="relative z-10" @close="open = false">
      ...
      <div class="fixed inset-0 z-10 w-screen overflow-y-auto p-4 sm:p-6 md:p-20">
        ...
        >
          <DialogPanel
            class="mx-auto max-w-3xl transform divide-y divide-gray-100 overflow-hidden rounded-xl bg-white shadow-2xl outline-1 outline-black/5 transition-all dark:divide-white/10 dark:bg-gray-900 dark:-outline-offset-1 dark:outline-white/10"
          >
            <Combobox v-slot="{ activeOption }" @update:modelValue="onSelect">
              ...
              <ComboboxOptions
                ...
                class="flex transform-gpu divide-x divide-gray-100 dark:divide-white/10"
                as="div"
                static
                hold
              >
                ...
                >
                  <h2
                    v-if="query === ''"
                    class="mt-2 mb-4 text-xs font-semibold text-gray-500 dark:text-gray-400"
                  >
                    Recent searches
                  </h2>
                  <div hold class="-mx-2 text-sm text-gray-700 dark:text-gray-300">
                    ...
                    >
                      ...
                      >
                        ...
                        <ChevronRightIcon
                          v-if="active"
                          class="ml-3 size-5 flex-none text-gray-400 dark:text-gray-500"
                          aria-hidden="true"
                        />
                      </div>
                    </ComboboxOption>
                ...
                <div
                  v-if="activeOption"
                  class="hidden h-96 w-1/2 flex-none flex-col divide-y divide-gray-100 overflow-y-auto sm:flex dark:divide-white/10"
                >
                  <div class="flex-none p-6 text-center">
                    <img
                      :src="activeOption.imageUrl"
                      alt=""
                      class="mx-auto size-16 rounded-full bg-gray-100 outline -outline-offset-1 outline-black/5 dark:bg-gray-800 dark:outline-white/10"
                    />
                  ...
                  <div class="flex flex-auto flex-col justify-between p-6">
                    <dl
                      class="grid grid-cols-1 gap-x-6 gap-y-3 text-sm text-gray-700 dark:text-gray-300"
                    >
                    ...
                    <button
                      type="button"
                      class="mt-6 w-full rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 dark:bg-indigo-500 dark:hover:bg-indigo-400 dark:focus-visible:outline-indigo-500"
                    >
                      Send message
                    </button>
                  </div>
