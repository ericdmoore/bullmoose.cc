  ...
  <TransitionRoot :show="open" as="template" @after-leave="rawQuery = ''" appear>
    <Dialog class="relative z-10" @close="open = false">
      ...
      <div class="fixed inset-0 z-10 w-screen overflow-y-auto p-4 sm:p-6 md:p-20">
        ...
        >
          <DialogPanel
            class="mx-auto max-w-xl transform divide-y divide-gray-100 overflow-hidden rounded-xl bg-white shadow-2xl outline-1 outline-black/5 transition-all dark:divide-white/10 dark:bg-gray-900 dark:-outline-offset-1 dark:outline-white/10"
          >
            <Combobox @update:modelValue="onSelect">
                    ...
                    >
                      <li
                        :class="[
                          ...
                          active && 'bg-indigo-600 text-white outline-hidden dark:bg-indigo-500',
                        ]"
                      >
                        <FolderIcon
                          :class="[
                            'size-6 flex-none',
                            active
                              ? 'text-white forced-colors:text-[Highlight]'
              ...
              <div v-if="rawQuery === '?'" class="px-6 py-14 text-center text-sm sm:px-14">
                ...
                <p class="mt-2 text-gray-500 dark:text-gray-400">
                  Use this tool to quickly search for users and projects across our entire platform.
                  You can also use the search modifiers found in the footer below to limit the
                  results to just users or projects.
                </p>
              </div>
              ...
              <div
                class="flex flex-wrap items-center bg-gray-50 px-4 py-2.5 text-xs text-gray-700 dark:bg-gray-800/50 dark:text-gray-300"
              >
                Type
                <kbd
                  :class="[
