  ...
  <TransitionRoot :show="open" as="template" @after-leave="query = ''" appear>
    <Dialog class="relative z-10" @close="open = false">
      ...
      <div class="fixed inset-0 z-10 w-screen overflow-y-auto p-4 sm:p-6 md:p-20">
        ...
        >
          <DialogPanel
            class="mx-auto max-w-2xl transform divide-y divide-gray-500/10 overflow-hidden rounded-xl bg-white/80 shadow-2xl outline-1 outline-black/5 backdrop-blur-sm backdrop-filter transition-all dark:divide-white/10 dark:bg-gray-900/80 dark:-outline-offset-1 dark:outline-white/10"
          >
                    ...
                    >
                      <li
                        :class="[
                          ...
                          active &&
                            'bg-gray-900/5 text-gray-900 outline-hidden dark:bg-white/5 dark:text-white',
                        ]"
                      >
                        <FolderIcon
                          :class="[
                            'size-6 flex-none',
                            !active && 'text-gray-900/40 dark:text-gray-500',
                            active && 'text-gray-900 dark:text-white',
                          ]"
                          aria-hidden="true"
                        />
                        <span class="ml-3 flex-auto truncate">{{ project.name }}</span>
                        <span v-if="active" class="ml-3 flex-none text-gray-500 dark:text-gray-400"
                          >Jump to...</span
                        >
                      </li>
                    </ComboboxOption>
                  ...
                  <ul class="text-sm text-gray-700 dark:text-gray-300">
                    ...
                    >
                      ...
                      >
                        ...
                        <span
                          class="ml-3 flex-none text-xs font-semibold text-gray-500 dark:text-gray-400"
                        >
