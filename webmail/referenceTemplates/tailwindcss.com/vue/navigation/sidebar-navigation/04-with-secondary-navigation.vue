          ...
          <ul role="list" class="-mx-2 space-y-1">
            <li v-for="item in navigation" :key="item.name">
              ...
              >
                <component
                  :is="item.icon"
                  class="size-6 shrink-0 text-gray-400 dark:text-current"
                  aria-hidden="true"
                />
                {{ item.name }}
              </a>
                ...
                <DisclosureButton
                  :class="[
                    item.current
                      ? 'bg-gray-50 dark:bg-white/5 dark:text-white'
                      : 'hover:bg-gray-50 dark:hover:bg-white/5 dark:hover:text-white',
                    'flex w-full items-center gap-x-3 rounded-md p-2 text-left text-sm/6 font-semibold text-gray-700 dark:text-gray-400',
                  ]"
                >
                  <component
                    :is="item.icon"
                  ...
                  <ChevronRightIcon
                    :class="[
                      open ? 'rotate-90 text-gray-500 dark:text-gray-400' : 'text-gray-400',
