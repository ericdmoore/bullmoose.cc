...
export function Bars4Icon(props: IconProps) {
  return (
    <Icon
      viewBox="0 0 24 24"
      inner={
...
export function CheckIcon(props: IconProps) {
  return (
    <Icon
      viewBox="0 0 24 24"
      inner={'<path stroke-linecap="round" stroke-linejoin="round" d="m4.5 12.75 6 6 9-13.5"/>'}
      stroke={true}
      {...props}
    />
  );
...
export function GlobeAmericasIcon(props: IconProps) {
  return (
    <Icon
      viewBox="0 0 24 24"
      inner={
