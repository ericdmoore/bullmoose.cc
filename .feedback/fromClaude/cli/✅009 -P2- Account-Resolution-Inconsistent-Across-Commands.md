...
**The failure is actively misleading:** `bullmoose log` defaults to *all* accounts (`main.ts:781`),
...
Guessing on the *send* path is exactly backwards — sending from the wrong identity is the one
