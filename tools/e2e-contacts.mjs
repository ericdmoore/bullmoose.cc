...
assert(
  acctCap?.maxAddressBooksPerCard === 1 && acctCap?.mayCreateAddressBook === true,
...
const [[, upd]] = await jmap([
  [
    "ContactCard/set",
    {
      ...
      update: {
        [adaId]: {
          "name/full": "Ada King, Countess of Lovelace",
          [`addressBookIds/${workId}`]: true,
