...
const home = await dav("PROPFIND", calHome, {
  headers: { Depth: "1" },
...
const list = await dav("PROPFIND", calHref, {
  headers: { Depth: "1" },
...
assert(
  tq.text.includes(`${standupId}.ics`) && !tq.text.includes(`${reviewId}.ics`),
...
const putIcs = [
  "BEGIN:VCALENDAR",
  "VERSION:2.0",
  "PRODID:-//Apple Inc.//Mac OS X 15.0//EN",
  "BEGIN:VEVENT",
  "UID:caldav-e2e-apple",
  "DTSTART;TZID=America/Chicago:20260810T130000",
  "DTEND;TZID=America/Chicago:20260810T141500",
  "SUMMARY:From Apple Calendar",
  "RRULE:FREQ=DAILY;UNTIL=20260815T045959Z",
  "END:VEVENT",
  "END:VCALENDAR",
  "",
].join("\r\n");
...
const [[, occ]] = await jmap([
  [
    "CalendarEvent/getOccurrences",
    { accountId: ERIC.acct, after: "2026-08-10T00:00:00Z", before: "2026-08-16T00:00:00Z" },
    "o",
  ],
]);
...
const home2 = await dav("PROPFIND", calHref, {
  headers: { Depth: "0" },
