...
const [g] = await jmap([
  [
    "Email/get",
    {
      accountId: ACCT,
      ids: [importedId],
      properties: ["subject", "from", "receivedAt", "mailboxIds", "keywords", "messageId"],
    },
    "g",
  ],
]);
