...
| `s33-assurance-ladder` | the assurance ladder + the passkey tea ceremony | ⚠️ **no role@ calls the ceremony yet** → #351 · **recovery rungs 2–3 unbuilt** (lost-both-devices is rungless) → #352 · directory import deferred by design → #353 |
