...
**I3.** *Unlocks* — `022`, `023`, `024` all name it, and `s03.C/readme.md:35` declares it
blocks `s03.D` and `s03.E`. *Human-verifiable* — the acceptance test is literally "run a
...
1. **The surface inventory has six rows and none is Contacts or Calendar** —
   ...
   exactly **one** hit, `arch.md:18`, and it is the unrelated phrase *"A single module owns
   all protocol contact"*. The parent arc declares four realms — Email · Contacts ·
...
2. **The `s03.A` dependency may be softer than stated.** A plain mail client renders fine
   without provenance columns. T1+T2 *could* ship ahead of `s03.A` — at the cost of the
