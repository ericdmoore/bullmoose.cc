...
| 6 | `services/jmap/wrangler.jsonc:142` refers to "services/auth" | No such directory. The AS is `services/oauth`, served at `auth.bullmoose.cc` — hostname and directory do not match |
