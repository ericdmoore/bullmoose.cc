...
isolation-first). The public-site rework — Astro, apps + connection guides —
is in `marketing-site.md`; it shipped on Cloudflare Pages and moved to R2
behind `services/sitehost` in #375, which that doc notes inline.
