...
| file                                                                   | what it is                                                                                                                                                                                                                                                                      |
| ---------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`on-your-own-domain.md`](on-your-own-domain.md)                       | **Start here.** Four worked paths from a bare domain to the first working thing — one person, a family, a business role address, a homelab — with every command on `example.com` rather than ours (#2).                                                                         |
